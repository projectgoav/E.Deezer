...
namespace E.Deezer.Endpoint
{
    public interface ISearchEndpoint
    {
        ...
        Task<IEnumerable<ITrack>> Advanced(string aQuery, uint aStart = 0, uint aCount = 100);
    ...
    internal class SearchEndpoint : ISearchEndpoint
    {
        ...
        public Task<IEnumerable<ITrack>> Advanced(string aQuery, uint aStart = 0, uint aCount = 100)
            => Get<Track, ITrack>(string.Empty, aQuery, aStart, aCount);
