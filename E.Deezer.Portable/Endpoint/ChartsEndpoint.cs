...
namespace E.Deezer.Endpoint
{
    public interface IChartsEndpoint
    {
        ...
        Task<IEnumerable<IAlbum>> GetAlbumChartForGenre(ulong aGenreId, uint aStart, uint aCount);
        ...
        Task<IEnumerable<IArtist>> GetArtistChartForGenre(ulong aGenreId);
        Task<IEnumerable<IArtist>> GetArtistChartForGenre(IGenre aGenre);

        Task<IEnumerable<IArtist>> GetArtistChart(uint aCount);
        Task<IEnumerable<IArtist>> GetArtistChartForGenre(ulong aGenreId, uint aCount);
        ...
        Task<IEnumerable<IArtist>> GetArtistChartForGenre(ulong aGenreId, uint aStart, uint aCount);
        ...
        Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(ulong aGenreId);
        Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(IGenre aGenre);

        Task<IEnumerable<IPlaylist>> GetPlaylistChart(uint aCount);
        Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(ulong aGenreId, uint aCount);
        ...
        Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(ulong aGenreId, uint aStart, uint aCount);
        ...
        Task<IEnumerable<ITrack>> GetTrackChartForGenre(ulong aGenreId);
        Task<IEnumerable<ITrack>> GetTrackChartForGenre(IGenre aGenre);

        Task<IEnumerable<ITrack>> GetTrackChart(uint aCount);
        Task<IEnumerable<ITrack>> GetTrackChartForGenre(ulong aGenreId, uint aCount);
        ...
        Task<IEnumerable<ITrack>> GetTrackChartForGenre(ulong aGenreId, uint aStart, uint aCount);
    ...
    internal class ChartsEndpoint : IChartsEndpoint
    {
        ...
        public Task<IChart> GetChart(ulong aGenreId)  => Get(aGenreId);
        public Task<IChart> GetChart(IGenre aGenre) => Get(aGenre.Id);

        /* ALBUMS */
        public Task<IEnumerable<IAlbum>> GetAlbumChart()                       => GetAlbumChart(0);
        public Task<IEnumerable<IAlbum>> GetAlbumChartForGenre(ulong aGenreId)   => GetAlbumChartForGenre(aGenreId, 0, iClient.ResultSize);
        ...
        public Task<IEnumerable<IAlbum>> GetAlbumChartForGenre(ulong aGenreId, uint aCount)   => GetAlbumChartForGenre(aGenreId, 0, aCount);
        ...
        public Task<IEnumerable<IAlbum>> GetAlbumChartForGenre(ulong aGenreId, uint aStart, uint aCount)  => Get<Album, IAlbum>("chart/{id}/albums", aGenreId, aStart, aCount);


        /* ARTISTS */
        public Task<IEnumerable<IArtist>> GetArtistChart()                      => GetArtistChart(0);
        public Task<IEnumerable<IArtist>> GetArtistChartForGenre(ulong aGenreId)  => GetArtistChartForGenre(aGenreId, 0, iClient.ResultSize);
        ...
        public Task<IEnumerable<IArtist>> GetArtistChartForGenre(ulong aGenreId, uint aCount)     => GetArtistChartForGenre(aGenreId, 0, aCount);
        ...
        public Task<IEnumerable<IArtist>> GetArtistChartForGenre(ulong aGenreId, uint aStart, uint aCount)    => Get<Artist, IArtist>("chart/{id}/artists", aGenreId, aStart, aCount);


        /* PLAYLISTS */
        public Task<IEnumerable<IPlaylist>> GetPlaylistChart()                      => GetPlaylistChart(0);
        public Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(ulong aGenreId)  => GetPlaylistChartForGenre(aGenreId, 0, iClient.ResultSize);
        ...
        public Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(ulong aGenreId, uint aCount)     => GetPlaylistChartForGenre(aGenreId, 0, aCount);
        ...
        public Task<IEnumerable<IPlaylist>> GetPlaylistChartForGenre(ulong aGenreId, uint aStart, uint aCount)    => Get<Playlist, IPlaylist>("chart/{id}/playlists", aGenreId, aStart, aCount);


        /* TRACKS */
        public Task<IEnumerable<ITrack>> GetTrackChart()                        => GetTrackChart(0);
        public Task<IEnumerable<ITrack>> GetTrackChartForGenre(ulong aGenreId)    => GetTrackChartForGenre(aGenreId, 0, iClient.ResultSize);
        ...
        public Task<IEnumerable<ITrack>> GetTrackChartForGenre(ulong aGenreId, uint aCount)   => GetTrackChartForGenre(aGenreId, 0, aCount);
        ...
        public Task<IEnumerable<ITrack>> GetTrackChartForGenre(ulong aGenreId, uint aStart, uint aCount)      => Get<Track, ITrack>("chart/{id}/tracks", aGenreId, aStart, aCount);
